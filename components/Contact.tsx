"use client";
// components/Contact.tsx — matches original exactly
  ...
  return (
    <>
      <style>{`
        ...
        .contact-form-left { padding:60px; border-right:1px solid rgba(255,255,255,0.05); display:flex; flex-direction:column; gap:0; }
        ...
        .contact-email:hover { color:var(--orange,#FF7700); }
        ...
        .contact-send-btn { display:inline-flex; align-items:center; gap:16px; background:none; border:1px solid rgba(255,255,255,0.15); padding:20px 32px; cursor:pointer; transition:border-color 0.25s,background 0.25s; text-decoration:none; position:relative; overflow:hidden; }
        ...
        .contact-send-btn:hover::before { transform:translateX(0); }
        .contact-send-btn:hover { border-color:var(--orange,#FF7700); }
      ...
      <section id="contact">
        ...
        <div className="contact-radar" aria-hidden="true">
          <div className="contact-radar-ring" />
          <div className="contact-radar-ring" />
          <div className="contact-radar-ring" />
        </div>
        ...
        <div className="contact-inner">
          ...
          <div className="contact-headline">
            <span className="contact-hl-top">{tagline}</span>
            <span className="contact-hl-main">{headline}</span>
            <span className="contact-hl-ghost">{headline}</span>
          </div>
          ...
          <div className="contact-form-area">
            <div className="contact-form-left">
              <div className="contact-field">
                ...
                <input type="text" placeholder="Jens De Meyer" />
              </div>
              <div className="contact-field">
                <label>Your Email</label>
                <input type="email" placeholder="hello@studio.be" />
              </div>
              <div className="contact-field">
            ...
            <div className="contact-form-right">
              <div>
                ...
                <p style={{ fontFamily: "var(--font-body)", fontWeight: 300, fontSize: 13, lineHeight: 1.9, color: "rgba(255,255,255,0.28)", maxWidth: 280 }}>
                  {descriptionText}
                </p>
              </div>

              <a href={`mailto:${email}`} className="contact-send-btn">
                <span className="contact-send-label">{ctaLabel}</span>
